/**
 * Class definition for JulianDate used for instantiating, modifying, and printing dates of the Julian Calendar.
 *
 * @author Ky Kartchner
 * @version 1.0
 */
public class JulianDate {
     ...
     */
    JulianDate(){
        JulianDate date = new JulianDate(1,1,1);   // Initialize date to 1/1/1
    ...
    /**
     * Sets the JulianDate to provided year, month, and day.
    ...
    /**
     * Returns whether or not the JulianDate is in a leap year
